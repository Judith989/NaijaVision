...
export default function DashboardPage() {
  ...
  const displayedCompensation = latest?.compensation_amount ?? (policy ? policy.amount * Math.max(1, languages.length) : null);
