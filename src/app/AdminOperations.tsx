...
export function AdminOperations() {
  ...
  return <section className="admin-operations" id="staff-management">
    ...
    <div className="ops-grid">
      ...
      <div className="ops-card"><h3>Reviewer compensation policy</h3><p className="ops-hint">Reviewers earn once for each unique video reviewed. Reviewing a replacement again does not duplicate the fee for that prompt.</p><p><b>Current:</b> {String(reviewerPolicy?.amount_per_video || 25)} {String(reviewerPolicy?.currency || "NGN")} per video</p><p>50 videos × ₦25 = ₦1,250</p><p>10 participants × 50 videos × ₦25 = ₦12,500</p></div>
